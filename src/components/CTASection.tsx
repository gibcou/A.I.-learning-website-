      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="mb-12">
          <h2 className="text-3xl md:text-5xl font-bold text-white mb-6">
            Start your AI journey with AI Master today!
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          <div className="text-center">
            ...
            <p className="text-blue-100 text-sm">See improvements in just 15 minutes a day</p>
          </div>
          ...
          <div className="text-center">
            ...
            <h3 className="text-lg font-semibold text-white mb-2">Increase Income</h3>
            <p className="text-blue-100 text-sm">Boost your earning potential with AI skills</p>
          </div>
          ...
          <div className="text-center">
            ...
            <h3 className="text-lg font-semibold text-white mb-2">Proven Method</h3>
            <p className="text-blue-100 text-sm">Join 1,180,774+ successful learners</p>
          </div>
        </div>
